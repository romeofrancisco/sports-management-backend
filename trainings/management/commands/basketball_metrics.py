"""
Command to simulate basketball training sessions and metrics.
"""
from django.core.management.base import BaseCommand
from teams.models import Team, Player
from trainings.models import TrainingMetric, TrainingSession, PlayerTraining, PlayerMetricRecord
...
class Command(BaseCommand):
    ...
    def _generate_metric_value(self, player, metric, previous_value, show_progress):
        ...
        unit_code = metric.metric_unit.code if metric.metric_unit else None
        ...
        seed_val = str(player.pk) + metric_name  # Use string concatenation to avoid attribute errors
        random_gen.seed(hash(seed_val))
        player_factor = random_gen.uniform(0.85, 1.15)
