...
class PositionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Position
        fields = "__all__"
        validators = []  # Disable DRF auto unique validators
    ...
    def validate(self, attrs):
        ...
        if qs_name.exists():
            raise serializers.ValidationError({"name": "This name is already used for this sport."})
        ...
        if abbreviation:
            ...
            if qs_abbr.exists():
                raise serializers.ValidationError({"abbreviation": "This abbreviation is already used for this sport."})
